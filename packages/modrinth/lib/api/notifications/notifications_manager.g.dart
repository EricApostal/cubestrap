...
part of 'notifications_manager.dart';
...
class _NotificationsManager implements NotificationsManager {
  _NotificationsManager(this._dio, {this.baseUrl, this.errorLogger});

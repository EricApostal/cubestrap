...
class _TeamsManager implements TeamsManager {
  _TeamsManager(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<List<TeamMember>> getProjectTeamMembers({
    ...
    final _options = _setStreamType<List<TeamMember>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/project/${object17}/members',
  ...
  Future<void> modifyTeamMember({
    required String id,
    required String object18,
    ModifyTeamMemberBody? body,
    Map<String, dynamic>? extras,
  }) async {
    final _extra = <String, dynamic>{};
    _extra.addAll(extras ?? <String, dynamic>{});

...
class _ThreadsManager implements ThreadsManager {
  _ThreadsManager(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<List<Report>> getOpenReports({
    ...
    final _options = _setStreamType<List<Report>>(
  ...
  Future<List<Thread>> getThreads({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<Thread>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/threads',

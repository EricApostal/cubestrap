...
class _VersionsManager implements VersionsManager {
  _VersionsManager(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<Version> getVersionFromIdOrNumber({
    required String object8,
    required String object9,
    Map<String, dynamic>? extras,
  }) async {
    final _extra = <String, dynamic>{};
    _extra.addAll(extras ?? <String, dynamic>{});
    ...
    final _options = _setStreamType<Version>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/project/${object8}/version/${object9}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<Version> createVersion({
    required CreatableVersion data,
    Map<String, dynamic>? extras,
  }) async {
    final _extra = <String, dynamic>{};
    _extra.addAll(extras ?? <String, dynamic>{});
  ...
  Future<void> addFilesToVersion({
    ...
    final _data = FormData();
    if (data != null) {
      _data.fields.add(MapEntry('data', data.name));
    }
    final _options = _setStreamType<void>(
      Options(
            method: 'POST',
